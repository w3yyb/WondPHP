...
use WondPHP\Contracts\Cookie as CookieContracts;


class Cookie  implements CookieContracts
{
    ...
    public function make($name, $value, $minutes = 0, $path = null, $domain = null, $secure = null, $httpOnly = true, $raw = false, $sameSite = null)
    {
        ...
        // }
        //    return $this;
        return new SymfonyCookie($name, $value, $time, $path, $domain, $secure, $httpOnly, $raw, $sameSite);
    }
    ...
    public function set($name, $value, $time,$path = null, $domain = null, $secure = null, $httpOnly = true, $raw = false, $sameSite = null)
    {
        return $this->make($name, $value, $time, $path, $domain, $secure, $httpOnly, $raw, $sameSite);
    }
